...
import { Terminal, Key, Code, Shield, Info, CheckCircle, Rocket, Zap, Users, GitBranch, GitMerge, BookOpen } from 'lucide-react';
...
const SectionHeader = ({ icon: Icon, color, title }: SectionHeaderProps) => (
